...
const APP_KEY ='b1715333da89c80c992e';
...
export default class App extends Component {
    ...
    componentWillMount(){
        console.log("getPermsissf", this.mediaHandler);
        this.mediaHandler.getPermissions()
        .then((stream) => {
            console.log("getPermsissf - end", stream );
